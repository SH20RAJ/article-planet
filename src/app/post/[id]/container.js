  ...
  <div className="row">
    ...
    <div className="col-md-2 col-xs-12">
      <div className="share">
        ...
        <ul className="svg-list">
          ...
          <li>
            <a
              href="https://gist.github.com/7c2c185f644945278027183ad16d3c6f"
              id="gist"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
    ...
    <div className="col-md-8 col-md-offset-2 col-xs-12">
      <div className="mainheading">
        ...
        <div className="row post-top-meta">
          ...
          <div className="col-md-10">
            <a id="author" className="link-dark" href="user.html?id=SH20RAJ">
              SH20RAJ
            </a>
            ...
            <span className="author-description">
              {" "}
              Find Interesting stuff here...
            </span>
            <br />
            <span id="post-date" className="post-date">
      ...
      <img
        ...
        src="https://articleplanet.github.io/assets/dot.png"
        alt="Cover Image"
      />
      {/* End Featured Image */}
      {/* Begin Post Content */}
      <div id="post-content" className="article-post">
        {html}
    </div>
      {/* End Post Content */}
      {/* Begin Tags */}
